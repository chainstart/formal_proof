...
Public release tag: <https://github.com/chainstart/formal_proof/releases/tag/wowii-local-girth-induced-tree-v2>
...
```text
FormalConjectures.WrittenOnTheWallII.GraphConjecture141
```
...
Local verification status recorded by the packaging pipeline:
`verified`.
